...
public class Department {
	public String name_not_insert = "|name_not_insert|company_name|work_line_name|";
	private int id;
	private String code;
	private String name;
	...
	public Department(int id, String code, String name, int work_line_id, int company_id, double budget_amount) {
		super();
		this.id = id;
		this.code = code;
		this.name = name;
