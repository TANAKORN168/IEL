...
public class Section {
	public String name_not_insert = "|name_not_insert|company_name|work_line_name|department_name|";
	private int id;
	private String code;
	private String name;
	...
	public Section(int id, String code, String name, int department_id, int work_line_id, int company_id,
