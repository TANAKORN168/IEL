        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
                <div class="col-md-5">
                  <a href="add_edit_tambon.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
                </div>
                <!-- /.col -->
                <div class="col-md-3">
              ...
              <table class="table table-hover table-bordered">
                <thead>
                  <tr class="bg-light-blue disabled ">
                    ...
                    <th class="text-center" style="width: 10%">รหัสตำบล</th>
                    <th class="text-center" style="width: 20%">ชื่อตำบล</th>
                    <th class="text-center" style="width: 20%">จังหวัด</th>
                    <th class="text-center" style="width: 20%">อำเภอ</th>
                ...
                <tbody id="body_list">
                	<c:forEach var="obj" items="${command}" varStatus="current"> 
                      ...
                      <td>${obj.name}</td>
                      <td>${obj.province_name}</td>
                      <td>${obj.amphur_name}</td>
                      <td align="center">
