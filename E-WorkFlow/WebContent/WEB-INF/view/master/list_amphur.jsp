...
<!-- Content Header (Page header) -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">ข้อมูลอำเภอ</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
                <div class="col-md-5">
                  <a href="add_edit_amphur.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
                </div>
                <!-- /.col -->
                <div class="col-md-3">
              ...
              <table class="table table-hover table-bordered">
                <thead>
                  <tr class="bg-light-blue disabled ">
                    ...
                    <th class="text-center" style="width: 10%">รหัสอำเภอ</th>
                    <th class="text-center" style="width: 30%">ชื่ออำเภอ</th>
                    <th class="text-center" style="width: 30%">จังหวัด</th>
