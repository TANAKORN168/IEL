        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
				<div class="col-md-5">
					<a href="add_edit_product.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
				</div>
				<!-- /.col -->
				<div class="col-md-3">
                ...
                <thead>
                  <tr class="bg-light-blue disabled ">
                    ...
                    <th class="text-center" style="width: 20%">ชื่อสินค้า</th>
                  	<th class="text-center" style="width: 35%">ข้อมูลสินค้า</th>
                ...
                <tbody id="body_list">
                	<c:forEach var="obj" items="${command}" varStatus="current"> 
                        ...
                        <td align="center">${obj.type}</td>
	                      ...
	                      <td align="center">${obj.barcode}</td>
	                      <td>${obj.full_name}</td>
	                      <td>${obj.full_discription}</td>
	                      <td align="center">
