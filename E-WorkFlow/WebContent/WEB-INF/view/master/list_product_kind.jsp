...
<!-- Content Header (Page header) -->
    ...
    <section class="content-header">
      <h1>ข้อมูลชนิดสินค้า/บริการ</h1>
      <ol class="breadcrumb">
        <li><a href="home.htm"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">ข้อมูลชนิดสินค้า/บริการ</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
                <div class="col-md-5">
                  <a href="add_edit_product_kind.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
                </div>
                <!-- /.col -->
                <div class="col-md-3">
              ...
              <table class="table table-hover table-bordered">
                <thead>
                  <tr class="bg-light-blue disabled ">
                    ...
                    <th class="text-center" style="width: 10%">รหัสชนิดสินค้า/บริการ</th>
                    <th class="text-center" style="width: 20%">ชื่อชนิดสินค้า/บริการ</th>
                    <th class="text-center" style="width: 20%">ประเภทสินค้า/บริการ</th>
                    <th class="text-center" style="width: 20%">กลุ่มสินค้า/บริการ</th>
                ...
                <tbody id="body_list">
                	<c:forEach var="obj" items="${command}" varStatus="current"> 
                      ...
                      <td>${obj.name}</td>
                      <td>${obj.product_type_name}</td>
                      <td>${obj.product_group_name}</td>
                      <td align="center">
