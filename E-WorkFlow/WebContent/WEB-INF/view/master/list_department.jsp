        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
                <div class="col-md-5">
                  <a href="add_edit_department.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
                </div>
                <!-- /.col -->
                <div class="col-md-3">
              ...
              <table class="table table-hover table-bordered">
                <thead>
                  <tr class="bg-light-blue disabled ">
                    ...
                    <th class="text-center" style="width: 10%">รหัสฝ่าย</th>
                    <th class="text-center" style="width: 15%">ชื่อฝ่าย</th>
                    <th class="text-center" style="width: 20%">บริษัท</th>
                    <th class="text-center" style="width: 20%">สายงาน</th>
