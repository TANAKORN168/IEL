        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
				<div class="col-md-5">
					<a href="add_edit_company.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
				</div>
				<!-- /.col -->
				<div class="col-md-3">
              ...
              <table class="table table-hover table-bordered">
                <thead>
                  <tr class="bg-light-blue disabled ">
                    <th style="width: 6%">#</th>
                    <th class="text-center" style="width: 10%">รหัสบริษัท</th>
                    <th class="text-center" style="width: 20%">ชื่อบริษัท</th>
                  	<th class="text-center" style="width: 10%">เลขประจำตัวผู้เสียภาษี</th>
					<th class="text-center" style="width: 20%">ที่อยู่</th>
					<th class="text-center" style="width: 6%">โทร</th>
					<th class="text-center" style="width: 7%">Email</th>
					<th class="text-center" style="width: 6%">Fax</th>
