...
<!-- Content Header (Page header) -->
    ...
    <section class="content-header">
      <h1>ข้อมูลกลุ่มสินค้า/บริการ</h1>
      <ol class="breadcrumb">
        <li><a href="home.htm"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">ข้อมูลกลุ่มสินค้า/บริการ</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <div class="row">
                <div class="col-md-5">
                  <a href="add_edit_product_group.htm" class="btn btn-info"><i class="fa fa-plus"></i> สร้าง</a>
                </div>
                <!-- /.col -->
                <div class="col-md-3">
              ...
              <table class="table table-hover table-bordered">
                <thead>
                  <tr class="bg-light-blue disabled ">
                    ...
                    <th class="text-center" style="width: 10%">รหัสกลุ่มสินค้า/บริการ</th>
                    <th class="text-center" style="width: 30%">ชื่อกลุ่มสินค้า/บริการ</th>
                    <th class="text-center" style="width: 30%">ประเภทสินค้า/บริการ</th>
